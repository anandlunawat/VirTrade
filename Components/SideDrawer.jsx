        ...
        <div className="fixed rounded-lg bg-opacity-70 left-0 top-[61px] h-[82vh] overflow-y-auto w-[20%]">
            <div className="flex flex-col bg-[#262424] rounded-lg bg-opacity-40 gap-2">
                ...
                <div className="flex flex-col h-full max-xl:gap-2 max-xl:items-center max-xl:justify-center max-xl:p-1 gap-2 p-4 text-white bg-black max-xl:fixed max-xl:w-[100vw] max-xl:h-[15%] max-xl:bottom-0 max-xl:flex-row bg-opacity-80">
                    ...
                    <button className={`flex max-xl:p-1 items-center xl:px-[25%] w-full gap-2 rounded-lg xl:p-1 max-xl:flex-col hover:bg-green-500 hover:text-black`} onClick={()=>{window.location = "/Transactions"}}><CgProfile /><span className='max-md:text-xs md:max-xl:text-2xl'>My Profile</span></button>
                </div>
            </div>
        </div>
    )
