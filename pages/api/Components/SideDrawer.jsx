export default function SideDrawer() {
    return (
        <div className="fixed max-xl:hidden bg-[#2a2929] bg-opacity-70 left-0 top-[61px] h-[82vh] overflow-y-auto w-[25%]">
            <div className="flex flex-col gap-2">
                <div className="flex px-2 py-3 ml-4 flex-col gap-2 pb-4 border-b-2 border-[#2a2929]">
                ...
                <div className="flex px-2 flex-col ml-4 gap-2 pt-2 2xl:pt-4 2xl:gap-4">
                ...
                <div className="flex px-2 ml-4 flex-row pt-4">
