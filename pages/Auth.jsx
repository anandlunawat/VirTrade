...
export default function Auth() {
    ...
    return (
        ...
        <Layout>
            <div>
                <div className="left-0 absolute top-20 flex flex-row gap-9 items-center justify-center right-0 ml-[25%] mr-[25%] p-5 border-[1px] border-slate-600 border-opacity-25 bg-[#262424] bg-opacity-25 rounded-xl max-lg:flex-col ">
                    ...
                    <form onSubmit={login} className="flex flex-col w-full p-6 text-white bg-transparent border-l-2 gap-9 max-sm:border-l-0 max-sm:p-0 max-sm:w-full max-lg:border-l-0 max-lg:p-0 max-lg:w-full" method="post">
                        ...
                        <button type="submit" className="p-2 text-lg font-semibold text-center bg-green-500 rounded-lg" >Login</button>
